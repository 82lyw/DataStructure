...
//template <typename ElemType>
//void displayPolynomial(MydisplayPolynomialLinkList<ElemType> rec)
//{
//	cout << endl;
//	cout << rec;
//}
...
template <typename ElemType>
void ex3_2_16(MyPolynomialLinkList<ElemType> & list1, char & continueYesNo)
{
	...
	while (1)
	{
		...
		switch (select)
		{
		case 1:ex3_2_16_1(list1, continueSelect);
			break;
		case 2:ex3_2_16_2(list1, continueSelect);
			break;
		case 3:ex3_2_16_3(list1, continueSelect);
			break;
		case 4:ex3_2_16_4(list1, continueSelect);
			break;
		case 5:ex3_2_16_5(list1, continueSelect);
			break;
...
template <typename ElemType>
void ex3_2_16_1(MyPolynomialLinkList<ElemType> & rec, char & continueSelect)
{
...
template <typename ElemType>
void ex3_2_16_2(MyPolynomialLinkList<ElemType> & rec, char & continueSelect)
{
...
template <typename ElemType>
void ex3_2_16_3(MyPolynomialLinkList<ElemType> & rec, char & continueSelect)
{
...
template <typename ElemType>
void ex3_2_16_4(MyPolynomialLinkList<ElemType> & rec, char & continueSelect)
{
...
template <typename ElemType>
void ex3_2_16_5(MyPolynomialLinkList<ElemType> & rec, char & continueSelect)
{
...
template <typename ElemType>
void ex3_2_16_6(MyPolynomialLinkList<ElemType> & rec, char & continueSelect)
{
